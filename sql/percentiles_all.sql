...
/* Select Percentiles */
drop table if exists percentiles_all_temp;

create table percentiles_all_temp ( pairId integer, lastUpdated time, p10 real, p30 real, p50 real, p70 real, p90 real, recordCount bigint);

insert into percentiles_all_temp (pairId, lastUpdated, p10, p30, p50, p70, p90, recordCount)
select
  pairId,
...
drop table if exists percentiles_all;
alter table percentiles_all_temp rename to percentiles_all;
